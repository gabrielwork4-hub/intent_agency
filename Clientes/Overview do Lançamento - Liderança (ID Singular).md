...
**desenvolvimento de liderança**, oferecendo um **Diagnóstico de Liderança gratuito** como porta de entrada.
...
**Gestor** (decide proposta) · **CHRO/Head** (aprova) · **Especialista** (valida método).
→ Detalhe: [[ICP - ID Singular]] (3 camadas).

## 🟦 Posicionamento (por que a ID ganha)
O mercado é "escala fria" (HSM, Conquer, FDC) **ou** "boutique sem método" (Lideraê). A ID ocupa o
...
| Ativo | Status |
|---|---|
| Estratégia, ICP, análise competitiva | ✅ pronto |
| Oferta (Diagnóstico de Liderança) | ✅ [[Oferta de Conversão - Liderança (ID Singular)]] |
| Copy da Landing Page | ✅ [[Copy LP - Diagnóstico de Liderança (ID Singular)]] |
| Copy de anúncios (Meta/Google/LinkedIn) | ✅ [[Anúncios - Liderança (ID Singular)]] |
| Plano de mídia + estrutura de campanha | ✅ |
| LP montada (form + GA4 + pixel) | ⬜ time/cliente |
| Logos/cases liberados + UTMs | ⬜ validar |
| E-mail/automação | ➖ fora do escopo |
