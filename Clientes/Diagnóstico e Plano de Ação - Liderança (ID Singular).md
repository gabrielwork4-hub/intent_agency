...
| 1 | Aprovar copy da LP e dos anúncios | Cliente | 19/06 | 🔴 alta |
| 2 | Liberar logos/cases para uso em anúncio | Cliente | 19/06 | 🔴 alta |
| 3 | Montar **LP com formulário** + GA4 + pixel | Time/cliente | 21/06 | 🔴 alta |
| 4 | Definir MQL + configurar eventos de conversão e UTMs | Nós + time | 20/06 | 🔴 alta |
